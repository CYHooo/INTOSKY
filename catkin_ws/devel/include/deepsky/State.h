// Generated by gencpp from file deepsky/State.msg
// DO NOT EDIT!


#ifndef DEEPSKY_MESSAGE_STATE_H
#define DEEPSKY_MESSAGE_STATE_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::deepsky::State_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::deepsky::State_<ContainerAllocator> const> ConstPtr;

}; // struct State_

typedef ::deepsky::State_<std::allocator<void> > State;

typedef boost::shared_ptr< ::deepsky::State > StatePtr;
typedef boost::shared_ptr< ::deepsky::State const> StateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::deepsky::State_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::deepsky::State_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::deepsky::State_<ContainerAllocator1> & lhs, const ::deepsky::State_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::deepsky::State_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::deepsky::State_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::deepsky::State_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::deepsky::State_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::deepsky::State_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::deepsky::State_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::deepsky::State_<ContainerAllocator> >
{
  ...
  static const char* value(const ::deepsky::State_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd9e0ec21a3e36387ULL;
  static const uint64_t static_value2 = 0x7a9dee3df8999bd1ULL;
};

template<class ContainerAllocator>
struct DataType< ::deepsky::State_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::deepsky::State_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::deepsky::State_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::deepsky::State_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::deepsky::State_<ContainerAllocator>& v)
  {
    s << indent << "mode: ";
