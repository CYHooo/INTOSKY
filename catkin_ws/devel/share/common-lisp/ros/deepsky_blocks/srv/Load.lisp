...
(cl:defmethod cl:initialize-instance :after ((m <Load-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Load-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky_blocks-srv:<Load-request> is deprecated: use deepsky_blocks-srv:Load-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Load-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Load-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky_blocks-srv:<Load-response> is deprecated: use deepsky_blocks-srv:Load-response instead.")))
...
(cl:defmethod names-val ((m <Load-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky_blocks-srv:names-val is deprecated.  Use deepsky_blocks-srv:names instead.")
  (names m))

(cl:ensure-generic-function 'programs-val :lambda-list '(m))
(cl:defmethod programs-val ((m <Load-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky_blocks-srv:programs-val is deprecated.  Use deepsky_blocks-srv:programs instead.")
  (programs m))
