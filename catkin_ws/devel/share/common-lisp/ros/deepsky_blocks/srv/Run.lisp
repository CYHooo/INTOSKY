...
(cl:defmethod cl:initialize-instance :after ((m <Run-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Run-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky_blocks-srv:<Run-request> is deprecated: use deepsky_blocks-srv:Run-request instead.")))

(cl:ensure-generic-function 'code-val :lambda-list '(m))
(cl:defmethod code-val ((m <Run-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky_blocks-srv:code-val is deprecated.  Use deepsky_blocks-srv:code instead.")
  (code m))
...
(cl:defmethod cl:initialize-instance :after ((m <Run-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Run-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky_blocks-srv:<Run-response> is deprecated: use deepsky_blocks-srv:Run-response instead.")))
