...
(cl:in-package deepsky_blocks-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Store-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Store-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky_blocks-srv:<Store-request> is deprecated: use deepsky_blocks-srv:Store-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Store-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky_blocks-srv:name-val is deprecated.  Use deepsky_blocks-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'program-val :lambda-list '(m))
(cl:defmethod program-val ((m <Store-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky_blocks-srv:program-val is deprecated.  Use deepsky_blocks-srv:program instead.")
  (program m))
...
(cl:defmethod cl:initialize-instance :after ((m <Store-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Store-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky_blocks-srv:<Store-response> is deprecated: use deepsky_blocks-srv:Store-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Store-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky_blocks-srv:success-val is deprecated.  Use deepsky_blocks-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <Store-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky_blocks-srv:message-val is deprecated.  Use deepsky_blocks-srv:message instead.")
  (message m))
