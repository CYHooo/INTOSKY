...
(cl:in-package deepsky_blocks-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Prompt>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Prompt)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky_blocks-msg:<Prompt> is deprecated: use deepsky_blocks-msg:Prompt instead.")))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <Prompt>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky_blocks-msg:message-val is deprecated.  Use deepsky_blocks-msg:message instead.")
  (message m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Prompt>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky_blocks-msg:id-val is deprecated.  Use deepsky_blocks-msg:id instead.")
  (id m))
