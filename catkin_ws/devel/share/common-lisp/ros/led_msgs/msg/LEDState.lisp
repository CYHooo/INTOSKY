...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LEDState>)))
  ...
  "a1eb2d2a032d0bbd86632db5a38717da")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LEDState)))
  "Returns md5sum for a message object of type 'LEDState"
  "a1eb2d2a032d0bbd86632db5a38717da")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LEDState>)))
  ...
  (cl:format cl:nil "# This message represents a state of an LED~%~%uint8 index # number of LED in a LED strip or other LEDs set~%uint8 r      # red component of the color, 0..255~%uint8 g      # green component of the color, 0..255~%uint8 b      # blue component of the color, 0..255~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LEDState)))
  "Returns full string definition for message of type 'LEDState"
  (cl:format cl:nil "# This message represents a state of an LED~%~%uint8 index # number of LED in a LED strip or other LEDs set~%uint8 r      # red component of the color, 0..255~%uint8 g      # green component of the color, 0..255~%uint8 b      # blue component of the color, 0..255~%~%~%"))
