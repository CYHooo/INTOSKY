...
(cl:defmethod idx-val ((m <SetLED-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader led_msgs-srv:idx-val is deprecated.  Use led_msgs-srv:idx instead.")
  (idx m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetLED-request>)))
  ...
  "94d4f582b80ded0946c565f123a05358")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetLED-request)))
  "Returns md5sum for a message object of type 'SetLED-request"
  "94d4f582b80ded0946c565f123a05358")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetLED-request>)))
  ...
  (cl:format cl:nil "# This service sets an LED color~%~%uint8 idx # number of LED in a LED strip or other LEDs set~%uint8 r        # red component of the color, 0..255~%uint8 g        # green component of the color, 0..255~%uint8 b        # blue component of the color, 0..255~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetLED-request)))
  "Returns full string definition for message of type 'SetLED-request"
  (cl:format cl:nil "# This service sets an LED color~%~%uint8 idx # number of LED in a LED strip or other LEDs set~%uint8 r        # red component of the color, 0..255~%uint8 g        # green component of the color, 0..255~%uint8 b        # blue component of the color, 0..255~%~%~%"))
