...
(cl:defmethod cl:initialize-instance :after ((m <SetVelocity-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetVelocity-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<SetVelocity-request> is deprecated: use deepsky-srv:SetVelocity-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetVelocity-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetVelocity-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<SetVelocity-response> is deprecated: use deepsky-srv:SetVelocity-response instead.")))
