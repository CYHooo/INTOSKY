...
(cl:defmethod cl:initialize-instance :after ((m <SetYaw-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetYaw-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<SetYaw-request> is deprecated: use deepsky-srv:SetYaw-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetYaw-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetYaw-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<SetYaw-response> is deprecated: use deepsky-srv:SetYaw-response instead.")))
