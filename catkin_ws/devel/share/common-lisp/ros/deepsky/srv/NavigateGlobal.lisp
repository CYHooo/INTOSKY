...
(cl:defmethod cl:initialize-instance :after ((m <NavigateGlobal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavigateGlobal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<NavigateGlobal-request> is deprecated: use deepsky-srv:NavigateGlobal-request instead.")))
...
(cl:defmethod speed-val ((m <NavigateGlobal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky-srv:speed-val is deprecated.  Use deepsky-srv:speed instead.")
  (speed m))
...
(cl:defmethod auto_arm-val ((m <NavigateGlobal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky-srv:auto_arm-val is deprecated.  Use deepsky-srv:auto_arm instead.")
  (auto_arm m))
...
(cl:defmethod cl:initialize-instance :after ((m <NavigateGlobal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavigateGlobal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<NavigateGlobal-response> is deprecated: use deepsky-srv:NavigateGlobal-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <NavigateGlobal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky-srv:success-val is deprecated.  Use deepsky-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <NavigateGlobal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky-srv:message-val is deprecated.  Use deepsky-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<NavigateGlobal-response>)))
  ...
  "deepsky/NavigateGlobalResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'NavigateGlobal-response)))
  "Returns string type for a service object of type 'NavigateGlobal-response"
  "deepsky/NavigateGlobalResponse")
