...
(cl:defmethod cl:initialize-instance :after ((m <SetYawRate-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetYawRate-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<SetYawRate-request> is deprecated: use deepsky-srv:SetYawRate-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetYawRate-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetYawRate-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<SetYawRate-response> is deprecated: use deepsky-srv:SetYawRate-response instead.")))
