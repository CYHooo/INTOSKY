...
(cl:defmethod cl:initialize-instance :after ((m <Execute-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Execute-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<Execute-request> is deprecated: use deepsky-srv:Execute-request instead.")))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <Execute-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky-srv:cmd-val is deprecated.  Use deepsky-srv:cmd instead.")
  (cmd m))
...
(cl:defmethod cl:initialize-instance :after ((m <Execute-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Execute-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<Execute-response> is deprecated: use deepsky-srv:Execute-response instead.")))

(cl:ensure-generic-function 'output-val :lambda-list '(m))
(cl:defmethod output-val ((m <Execute-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky-srv:output-val is deprecated.  Use deepsky-srv:output instead.")
  (output m))

(cl:ensure-generic-function 'code-val :lambda-list '(m))
(cl:defmethod code-val ((m <Execute-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky-srv:code-val is deprecated.  Use deepsky-srv:code instead.")
  (code m))
