...
(cl:defmethod cl:initialize-instance :after ((m <SetAttitude-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAttitude-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<SetAttitude-request> is deprecated: use deepsky-srv:SetAttitude-request instead.")))
...
(cl:defmethod thrust-val ((m <SetAttitude-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepsky-srv:thrust-val is deprecated.  Use deepsky-srv:thrust instead.")
  (thrust m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetAttitude-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAttitude-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<SetAttitude-response> is deprecated: use deepsky-srv:SetAttitude-response instead.")))
