...
(cl:defmethod cl:initialize-instance :after ((m <SetRates-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetRates-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<SetRates-request> is deprecated: use deepsky-srv:SetRates-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetRates-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetRates-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deepsky-srv:<SetRates-response> is deprecated: use deepsky-srv:SetRates-response instead.")))
