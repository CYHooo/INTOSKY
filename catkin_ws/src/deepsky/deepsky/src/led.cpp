...
#include <deepsky/SetLEDEffect.h>
...
deepsky::SetLEDEffect::Request current_effect;
int led_count;
ros::Timer timer;
ros::Time start_time;
...
bool setEffect(deepsky::SetLEDEffect::Request& req, deepsky::SetLEDEffect::Response& res)
{
	res.success = true;
